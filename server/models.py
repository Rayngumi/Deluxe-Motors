...
class Feature(db.Model):
    ...
    vehicles = db.relationship("Vehicle", secondary="vehicle_features")  
...
class Vehicle(db.Model):
    ...
    features = db.relationship("Feature", secondary="vehicle_features") 
...
class VehicleFeatures(db.Model):
    ...
    vehicle_id = db.Column('vehicle_id', db.Integer, db.ForeignKey('vehicles.vehicle_id'), primary_key=True)
    feature_id = db.Column('feature_id', db.Integer, db.ForeignKey('features.feature_id'), primary_key=True)
